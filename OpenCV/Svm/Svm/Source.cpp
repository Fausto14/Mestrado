...
FILE* file;
char address[500] = "C:\\Users\\fadell\\Documents\\num_padronizado_MomCent_OpenCv.txt";//Banco de dados - Carregar
char addressSave[500] = "C:\\Users\\fadell\\Documents\\DataBase_Normalized.txt";//Banco de dados normalizado - Salvar
...
void PegarQuantidadeDeObjetoPorClasse(int quantidadeClasses, int numObjPorClasses[], int objetos, Mat label) {
...
void leave_on_out(float percentualTreino, float percentualTeste, int quantidadeDeClasses, int NumObjPorClasse[], float atributos, float objetos, Mat label, Mat atrib, Mat Treino, Mat Teste, Mat TreinoLabel, Mat TesteLabel) {
...
void hold_out(float percentualTreino, float percentualTeste, int quantidadeDeClasses, int NumObjPorClasse[], float atributos, float objetos, Mat label, Mat atrib, Mat Treino, Mat Teste, Mat TreinoLabel, Mat TesteLabel) {
	int y;
	int contadorTreino = -1;
	int contadorTeste = -1;
	for (int controle = 0; controle<quantidadeDeClasses; controle++) {
