//
//  MLPedrosa.c
//  Framework_ICA_Pedrosa_v6
//
//  Created by Pedro Pedrosa Rebouças Filho on 02/01/17.
//  Copyright (c) 2017 Pedro Pedrosa Rebouças Filho. All rights reserved.
...
//         }
	...
	sprintf(directory, "/Users/LIA/Documents/X_CODE_Projects/Fausto_Couro/DB_ICA/DB_GLCM");
	sprintf(name_file_in_txt, "DB_GLCM.txt");
  ...
  //  quantidadeAtributos = 3;
	...
	percentualTreino = 0.75; //teste = 1 - treino
        
	quantidadeClasses = 7;
        
	quantidadeIteracoes = 10;
	...
	int SVM_auto = 1; //1 - parametros automaticos, 0 - parametros fixos
