function [matrixAccClasseRodReso somaEscoresAcertosResoGeral somaEscoresErrosResoGeral] = gerarDados5(param,conf)
...
%%ABRIR ARQUIVO
nameFile = sprintf('results/5_Base%d_resultsSVM_train%d_SIGMA%.2f_R%d_%s.txt',base,ptrn*100,conf.sigma,numRodadas,conf.fkernel);
nameFile2 = sprintf('results/5_Base%d_Resumo_resultsSVM_train%d_SIGMA%.2f_R%d_%s.txt',base,ptrn*100,conf.sigma,numRodadas,conf.fkernel);
...
fileSaveAcc = sprintf('5_acc_Base%d_Rods%d.mat',param.base,numRodadas);
fileSaveAcertos = sprintf('5_acertos_Base%d_Rods%d.mat',param.base,numRodadas);
fileSaveErros = sprintf('5_erros_Base%d_Rods%d.mat',param.base,numRodadas);
