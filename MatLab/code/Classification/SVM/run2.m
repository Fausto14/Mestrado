...
%%ABRIR ARQUIVO
nameFile = sprintf('results/2resultsSVM_train%d_SIGMA%.2f_R%d_%s.txt',ptrn*100,conf.sigma,numRodadas,conf.fkernel);
nameFile2 = sprintf('results/2Resumo_resultsSVM_train%d_SIGMA%.2f_R%d_%s.txt',ptrn*100,conf.sigma,numRodadas,conf.fkernel);
...
matrizErrosClasse(2,:) = [0 0 15 25 45 60 80];
matrizErrosClasse(3,:) = [0 0 0 15 25 45 60];
matrizErrosClasse(4,:) = [0 0 0 0 15 25 45];
matrizErrosClasse(5,:) = [0 0 0 0 0 15 25];
matrizErrosClasse(6,:) = [0 0 0 0 0 0 15];
matrizErrosClasse(7,:) = [0 0 0 0 0 0 0];
...
for reso = resolucoes
    ...
    fileGLCM = sprintf('../PASSO_ROI_PRETO/GLCM_%d.txt',reso*100);
    temp = load(fileGLCM);
...
for k = 1 : qtdClasses
    ...
    nameFileGraph = sprintf('graphics/classes_x_resolucao/2C%d_Rods%d.png',k,numRodadas);
...
for k = 1 : resoFim
    ...
    nameFileGraph = sprintf('graphics/resolucao_x_classes/2Reso%d%%_Rods%d.png',k,numRodadas);
    saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/2BoxPlot_Acertos_Rods%d.png',numRodadas);
saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/2BoxPlot_Erros_Rods%d.png',numRodadas);
saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/2BoxPlot_Valor_Rods%d.png',numRodadas);
saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/2Line_Acurácia_Acertos_Erros_Rods%d.png',numRodadas);
saveas(gcf,nameFileGraph);
