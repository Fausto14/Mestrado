function gerarGraficos70(base,param)
...
fileAcc = sprintf('70_acc_Base%d_Rods%d.mat',base,numRodadas);
fileAcertos = sprintf('70_acertos_Base%d_Rods%d.mat',base,numRodadas);
fileErros = sprintf('70_erros_Base%d_Rods%d.mat',base,numRodadas);
...
for k = 1 : qtdClasses
    ...
    nameFileGraph = sprintf('graphics/classes_x_resolucao/70_Base%d_C%d_Rods%d.png',base,k,numRodadas);
...
for k = (resoIni:1:resoFim)
    ...
    nameFileGraph = sprintf('graphics/resolucao_x_classes/70_Base%d_Reso%d_Rods%d.png',base,k,numRodadas);
    saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/70_Base%d_BoxPlot_Acertos_Rods%d.png',base,numRodadas);
saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/70_Base%d_BoxPlot_Erros_Rods%d.png',base,numRodadas);
saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/70_Base%d_BoxPlot_Valor_Rods%d.png',base,numRodadas);
saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/70_Base%d_Line_Acurácia_Acertos_Erros_Rods%d.png',base,numRodadas);
saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/70_Base%d_Line_Valor_Rods%d.png',base,numRodadas);
saveas(gcf,nameFileGraph);
...
nameFileGraph = sprintf('graphics/escores_x_classificador/70_Base%d_Line_Acurácia_Rods%d.png',base,numRodadas);
saveas(gcf,nameFileGraph);
